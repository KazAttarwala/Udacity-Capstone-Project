...
class CastingTestCase(unittest.TestCase):
    ...
    def test_create_actor(self):
        headers = getUserToken(self.director['username'], self.director['password'])
    ...
    def test_get_actors(self):
        headers = getUserToken(self.assistant['username'], self.assistant['password'])
    ...
    # client id and secret come from LogIn (Test Client)! which has password enabled under "Client > Advanced > Grant Types > Tick Password"
        ...
        headers = {'content-type': 'application/json'}
        parameter = { "client_id": 'HYvLh1Lx749x5OP7TJsmq2cQF0JjHQ9S',
                    "client_secret": '0HLvPA5IMBxEoKxQ8Hh6wECsO32jq3pczn_hmNqzUSDPKsvz8q6gKBXIYdYW9dNt',
